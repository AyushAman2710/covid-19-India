...
$(document).ready(function(){
 ...
 console.log(state)
  ...
  total_active_RJ=data.statewise[13].active
  total_confirmed_RJ=data.statewise[13].confirmed
  total_recovered_RJ=data.statewise[13].recovered
  total_deaths_RJ=data.statewise[13].deaths
...
total_active_KA=data.statewise[3].active
total_confirmed_KA=data.statewise[3].confirmed
total_recovered_KA=data.statewise[3].recovered
total_deaths_KA=data.statewise[3].deaths
...
total_active_HR=data.statewise[17].active
total_confirmed_HR=data.statewise[17].confirmed
total_recovered_HR=data.statewise[17].recovered
total_deaths_HR=data.statewise[17].deaths
...
total_active_AP=data.statewise[2].active
total_confirmed_AP=data.statewise[2].confirmed
total_recovered_AP=data.statewise[2].recovered
total_deaths_AP=data.statewise[2].deaths
...
total_active_TA=data.statewise[10].active
total_confirmed_TA=data.statewise[10].confirmed
total_recovered_TA=data.statewise[10].recovered
total_deaths_TA=data.statewise[10].deaths

$("#active_TA").append(total_active_TA)
$("#confirmed_TA").append(total_confirmed_TA)
$("#recovered_TA").append(total_recovered_TA)
$("#deaths_TA").append(total_deaths_TA)
